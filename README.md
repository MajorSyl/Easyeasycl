...
- [ ] Decide which app icon to ship: `assets/icon-blue-bg.png` (current, white mark on brand blue) vs `assets/icon-black-white.png` (literal brand-kit black-on-white) — both generated for comparison, neither wired into `app.json` yet
